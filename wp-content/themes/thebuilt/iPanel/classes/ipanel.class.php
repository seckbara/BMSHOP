...
if (!class_exists('IPANEL')) {
    ...
    class IPANEL
    {
        ...
        public function menuPage()
        {
            ...
            $theme_key_var = 'thebuilt_license_key_status';
            ...
            if(isset($_REQUEST['act']) && $_REQUEST['act'] == 'registration_complete') {
              update_option($theme_key_var, 'activated');
              delete_option('thebuilt_license_skip_date');
            }

            if(isset($_REQUEST['act']) && $_REQUEST['act'] == 'registration_reset') {
              delete_option($theme_key_var);
              delete_option('thebuilte_license_skip_date');
            }

            if(isset($_REQUEST['act']) && $_REQUEST['act'] == 'registration_skip') {
              update_option('thebuilt_license_skip_date', strtotime("+1 day"));
              update_option($theme_key_var, 'activated');
            }

            if(strtotime("now") > get_option( 'thebuilt_license_skip_date', 0 ) && get_option( 'thebuilt_license_skip_date', 0 ) > 0) {
              delete_option('thebuilt_license_skip_date');
              delete_option($theme_key_var);
            }
            ...
            <div class="ipanel-form-stuff" style="margin-top: 20px;">
               ...
               <a class="button button-primary ipanel-more-themes" target="_blank" href="http://magniumthemes.com/themes/"><?php echo esc_html__('Premium WordPress Themes', 'thebuilt'); ?></a>
                <a class="button button-secondary ipanel-more-themes" target="_blank" href="http://support.magniumthemes.com/"><?php echo esc_html__('Support Center', 'thebuilt'); ?></a>
                <?php if ($livePreview) {
                    ...
                    <tr>
                            ...
                            <!-- Left Side-->
                                <div id="ipanel-tabs">
                                    <ul>
                                        ...
                                        ?>
                                        <li id="tab-registration"><a href="#" data-target="registration"><?php esc_html_e('Theme Registration', 'thebuilt'); ?></a></li>
                                        <?php endif; ?>
                        ...
                        <td id="ipanel-fields-container">
                            <div>
                                ...
                                <form id="theme-activation-form" action="themes.php?page=ipanel_THEBUILT_PANEL&act=activation" method="POST">
                                <div class="theme-activation-wrapper">
                                  <h1><?php esc_html_e('Welcome to TheBuilt!', 'thebuilt'); ?></h1>
                                  <p class="text-large"><?php echo wp_kses_post('TheBuilt is now installed and ready to use! Please register your purchase to get themes updates notifications,<br>import theme demos and get access to premium dedicated support. We hope you enjoy it!', 'thebuilt'); ?></p>
                                  <input required name="email" type="email" class="activate-theme-email" placeholder="<?php esc_html_e('Enter your email', 'thebuilt'); ?>"/><br/><input name="code" type="text" placeholder="<?php esc_html_e('Enter your theme purchase code', 'thebuilt'); ?>" class="activate-theme-code"/>
                                  <a href="http://magniumthemes.com/go/how-to-find-purchase-code/" target="_blank" class="activate-theme-subblink"><?php esc_html_e('How to find your theme purchase code?', 'thebuilt'); ?></a><br>
                                  <input type="checkbox" checked name="subscribe" id="subscribe" class="activate-theme-subscribe"> <label class="radio-inline" for="subscribe"><?php esc_html_e('Receive theme updates notifications and news', 'thebuilt'); ?></label><br><br/><input required class="button button-primary button-hero activate-theme-btn" type="button" value="<?php esc_html_e('Register theme', 'thebuilt'); ?>"/>
            ...
            <div class="ipanel-form-stuff">
                ...
                <button class="button button-secondary ipanel-reset-settings"><i class="ipanel-black-icon trash"></i> <?php echo esc_html__('Reset theme options', 'thebuilt'); ?></button>
